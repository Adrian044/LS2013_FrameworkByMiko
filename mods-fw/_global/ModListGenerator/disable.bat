...
%app_xml% ed -d "/root/mod[@name='%modName%']" -s "/root" -t elem -n mod -v "" -a "/root/mod[last()]" -t attr -n name -v "%modName%" -a "/root/mod[last()]" -t attr -n enable -v false %path_tmp_file% > %path_tmp2_file% 
