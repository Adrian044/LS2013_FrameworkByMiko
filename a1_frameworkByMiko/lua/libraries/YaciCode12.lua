...
local function obj_newitem() error "May not modify the class '__Object'. Subclass it instead." end
...
function obj_inst_stuff.class() return __Object end
...
function obj_class_stuff.name(class) return "__Object" end
function obj_class_stuff.super(class) return nil end
function obj_class_stuff.inherits(class, other) return false end
metaObj[__Object] = { virtuals={} }

local function tos() return ("class __Object") end
setmetatable(__Object, { __newindex = obj_newitem, __index = obj_class_stuff, 
	__tostring = tos, __call = newInstance } )
...
function newclass(name, baseClass)
 baseClass = baseClass or __Object
 return baseClass:subclass(name)
end

end -- 2 global things remain: '__Object' and 'newclass'
